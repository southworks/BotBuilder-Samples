...
ChatBot built with Bot Composer V2.0.0 - testing
...
[![Build Status](https://vap-jenkins.optum.com/job/AZURE/job/BOT/job/omni-vui-policyselection-sb-cmp-services/job/master/badge/icon)](https://vap-jenkins.optum.com/job/AZURE/job/BOT/job/omni-vui-policyselection-sb-cmp-services/job/master/)
...
```json
{
  "botium": {
    "Capabilities": {
      "PROJECTNAME": "omni-vui-policyselection-sb-cmp",
